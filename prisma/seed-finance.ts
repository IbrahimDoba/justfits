...
// Real historical data imported from Batch_2_edited_4.xlsx (Sales + Expenses sheets).
// Dates from Excel serials have been normalised to ISO. Amounts in NGN.
...
async function main() {
  ...
  console.log(`Imported ${sales.length} sales and ${expenses.length} expenses.`);
  console.log(
