...
export default function Home() {
  return (
    <main className="min-h-screen bg-white">
      ...
      {/* WhatsApp bottom bar — mobile only */}
      <a
        href="https://wa.me/2348149113328"
        target="_blank"
        rel="noopener noreferrer"
        className="sm:hidden fixed bottom-0 left-0 right-0 z-50 flex items-center justify-center gap-3 bg-[#25D366] text-white py-4 font-medium text-sm shadow-lg"
      >
        {/* WhatsApp icon */}
        <svg
